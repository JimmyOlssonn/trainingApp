    ...
    <div class="container-fluid mt-5">
        <div class="row py-3">
            ...
            <div class="col-xl-6 col-lg-10 col-md-10 col-sm-12">
                <h1>Add new run</h1>
                <div id="map"></div>
                <button id="startPoint" type="button" class="btn btn-primary active" onclick="changeMarkerType('stop')">Start-point</button>
                <button id="endPoint" type="button" class="btn btn-outline-primary" onclick="changeMarkerType('start')">End-point</button>

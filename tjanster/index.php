    ...
    <section>
        ...
        <section class="auto-container container-dark">
            ...
            <div id="service" class="flex-container">
                ...
                <div class="column-33 column-services">
                    <h2 class="title-md title-center text-red"><i class="fas fa-dumbbell"></i></h2>
                ...
                <div class="column-33 column-services">
                    <h2 class="title-md title-center text-red"><i class="far fa-calendar-check"></i></h2>
                ...
                <div class="column-33 column-services">
                    <h2 class="title-md title-center text-red"><i class="far fa-handshake"></i></h2>

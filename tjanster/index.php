        ...
        <section class="auto-container container-dark">
            ...
            <div id="service" class="flex-container">
                <div class="column-33 column-services">
                    <h2 class="title-md title-center text-green"><i class="far fa-clock"></i></h2>
                ...
                <div class="column-33 column-services">
                    <h2 class="title-md title-center text-green"><i class="fas fa-dumbbell"></i></h2>
                ...
                <div class="column-33 column-services">
                    <h2 class="title-md title-center text-green"><i class="fas fa-dollar-sign"></i></h2>
                ...
                <div class="column-33 column-services">
                    <h2 class="title-md title-center text-green"><i class="far fa-calendar-check"></i></h2>
                ...
                <div class="column-33 column-services">
                    <h2 class="title-md title-center text-green"><i class="fas fa-chart-line"></i></h2>
                    <p>Se dina resultat i ett diagram, för bästa översikt över dina egna träningar och resultat.</p>
                </div>
                <div class="column-33 column-services">
                    <h2 class="title-md title-center text-green"><i class="far fa-handshake"></i></h2>
